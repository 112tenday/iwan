...
public class AccountServiceImpl implements AccountService {
    ...
    public Account save(AccountDto accountDto) {
        ...
        account.setCreatedDate(new java.sql.Timestamp(Calendar.getInstance().getTimeInMillis()));
    ...
    public Account update(AccountDto accountdDto) {
        ...
        if (acc.isPresent()) {
            ...
            account.setUpdateDate(new java.sql.Timestamp(Calendar.getInstance().getTimeInMillis()));
            return repository.save(account);
        }
